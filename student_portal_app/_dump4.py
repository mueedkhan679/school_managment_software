...
for fname, lo, hi in [
    (r'lib\views\fee_view.dart', 160, 339),
    (r'lib\views\digital_id_card_view.dart', 1, 130),
    (r'lib\views\digital_id_card_view.dart', 242, 336),
    (r'lib\views\attendance_view.dart', 1, 206),
    (r'lib\views\qr_scan_view.dart', 1, 228),
]:
    path = base + '\\' + fname
...
with io.open(base + r'\_dump_out2.txt', 'w', encoding='utf-8') as fh:
    fh.write('\n'.join(out))
print('done')
